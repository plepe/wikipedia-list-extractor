...
There's a demo-application where you can view items on a map: https://openstreetmap.at/demo-wikipedia-list-extractor ([Source](https://github.com/plepe/demo-wikipedia-list-extractor)).
